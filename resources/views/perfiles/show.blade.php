...
@section('content')
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-7 mt-5 mt-md-0">
        ...
        <a href="{{ $perfil->usuario->url }}" target="_blank">Visitar mi sitio web</a>
        <div class="biografia">
          {!! $perfil->biografia !!}
        </div>
      </div>
  ...
  <h2>Recetas creadas por: {{ $perfil->usuario->name }}</h2>
  ...
  <div class="container">
    <div class="row mx-auto bg-white p-4">
      @if ( count($recetas) > 0 )
        ...
        @endforeach
      @else
        <p class="text-center w-100">No tiene recetas aún...</p>
      @endif
    </div>
